...
- [blocks.lua](./blocks.lua.md)
    ...
    - [Block Features](./block_features.md)
    - [Block Extensions](./block_extensions.md)
        - [Getting the most out of block extensions](./getting_the_most_out_of_block_extensions.md)
    ...
    - [Resource Producers](./resource_producers.md)
    ...
    - [Explosive Blocks](./explosive_blocks.md)
    - [Invulnerable Blocks](./invulnerable_blocks.md)
    - [Blocks with Lifetimes](./blocks_with_lifetimes.md)
    - [Noclipping Blocks](./noclipping_blocks.md)
